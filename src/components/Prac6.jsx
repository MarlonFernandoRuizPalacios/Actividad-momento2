...
const Prac6 = () => {
  ...
  useEffect(() => {
    ...
    // Grave / Cross - material para cruces
    ...
    for (let i = 0; i < 30; i++) {
      ...
      cross.rotation.x = (Math.random() - 0.5) * 0.1;
      cross.rotation.y = (Math.random() - 0.5) * 0.6;
      cross.rotation.z = (Math.random() - 0.5) * 0.1;
    ...
    // activar sombras en todas las cruces
    for (const cross of graves.children) {
      cross.traverse((c) => {
        if (c.isMesh) {
          c.castShadow = true;
